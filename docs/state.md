...
- Text Sage via Linq (2026-03-31): Full texting integration replacing Twilio. Shared `persona-pipeline.ts` ensures zero drift between web and text. Checkpoint flow works via text (YES/NOT QUITE/NO). STOP/START/HELP keywords, rate limiting, cross-channel continuity (TEXT badge in web).
