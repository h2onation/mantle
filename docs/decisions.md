...
**Status**: Settled (2026-04-16) — **with a blocking follow-up: Upstash env vars missing in prod.**
...
- The `transcript_detected` suppression branch in `call-persona.ts:330-332` is no longer needed once the template is shared.
