...
Three themes via `[data-theme]` attribute on `<body>`:
...
```
--color-accent:       #7B9EC4
--color-accent-dim:   rgba(123, 158, 196, 0.4)
--color-accent-ghost: rgba(123, 158, 196, 0.08)
--color-accent-glow:  rgba(123, 158, 196, 0.12)
--color-warm:         #141618
```
...
- Theme toggle: Sage/Ember/Depth, instant switch, localStorage persistence, no flash
