...
// Per-layer emblem icons, matching the v6 prototype's Manual read view and
// the Home index (Tabler: sparkles / refresh / bulb / anchor / users).
// Stroke icons sized to sit inside a rounded-square emblem.
